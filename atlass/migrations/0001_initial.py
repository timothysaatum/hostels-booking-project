# Generated by Django 4.1.7 on 2023-07-16 07:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('check_in', models.DateField(default=datetime.datetime.now, help_text='YYYY-MM-DD')),
                ('number_of_guests', models.PositiveIntegerField(default=1)),
                ('phone_number', models.CharField(blank=True, editable=False, max_length=17, null=True)),
