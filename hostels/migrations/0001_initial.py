    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="unarcom",
                        help_text="Enter name of hostel owner",
                        max_length=100,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        default="Main Campus",
                        help_text="Enter campus the hostel is located",
                        max_length=100,
                    ),
                ),
                (
                    "hostel_name",
                    models.CharField(default="unnamed hostel", max_length=50),
                ),
                ("contact", models.CharField(help_text="0589 693 6595", max_length=10)),
                (
                    "display_image",
                    models.ImageField(
                        blank=True, default=None, upload_to="unarcom/hostel/images"
                    ),
                ),
                ...
                (
                    "hostel_coordinates",
                    models.CharField(help_text="latitude, longitude", max_length=100),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        default=None,
                        null=True,
                        upload_to="unarcom/room_type/images",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "room_type_images",
                    models.ImageField(
                        blank=True, default=None, upload_to="unarcom/room_type/images"
                    ),
                ),
                (
                    "room",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="hostels.school"
            ),
        ),
    ]
