...
from .views import (AboutView, HomeView, Services, user_dashboard, HowItWorks, Mission, HostelsListView, make_booking, CreateHostel, Management, verify_booking, HostelDelete, HostelUpdate, RoomsListView, RoomTypeCreateView, 
                    make_payment, GeneratePdf, HostelDetailView, VacantRooms, BookingsView, PendingView, ApprovalsView, SalesStatistics, RoomDetailView)
