$(document).ready(function () {
  ...
  $(".show-div, .search-form, .show-btn, .empty-rooms, .adminMenu").hide();
  ...
  //end of admin mobile menu
  $("#menuButton").click(function(){
    $(".adminMenu").toggle();
    //alert('Ok')
  });
  $(".adminMenu button").click(function(){
    alert('ok')
  });
  ...
  $("#vacancies, #mobile-vacancies").click(function(){
    $("#update").load("/admin/dashboard/vacancies/");
    //alert('Done loading content');
  });
  $("#update-content, #mobile-bookings").click(function(){
  ...
  $("#leaves, #mobile-leaves").click(function(){
